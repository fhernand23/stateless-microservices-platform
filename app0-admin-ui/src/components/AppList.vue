...
<template>
  <div class="list-view-toolbar">
    ...
    <VButtons align="right">
      <VButton :to="{ name: 'app-edit', params: { objId: 'new' } }" color="primary" icon="fas fa-plus" raised elevated>
        Add App
      </VButton>
    </VButtons>
  </div>
        ...
        <div v-for="obj in filteredData" :key="obj.id" class="column is-4">
          <div class="tile-grid-item">
            <div class="tile-grid-item-inner">
              <RouterLink :to="{ name: 'app-edit', params: { objId: obj.id } }">
                <VIconBox size="medium" color="primary" rounded>
                  <i class="iconify" data-icon="icon-park-outline:all-application"></i>
                </VIconBox>
              </RouterLink>
              <div class="meta">
                <RouterLink :to="{ name: 'app-edit', params: { objId: obj.id } }">
