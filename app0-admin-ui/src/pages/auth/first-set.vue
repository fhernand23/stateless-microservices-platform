  ...
  if (!isLoading.value) {
    ...
    try {
      if (validateForm()) {
        ...
        if (ret.status == 200) {
          notyf.success('Setup successfull')
          router.push({ name: 'login' })
        } else {
          notyf.error('Setup successfull')
        }
      }
    } catch (error: any) {
...
useHead({
  title: 'Platform initial password setup',
})
</script>
              ...
              <div class="login-form">
                ...
                <VField>
                  <VControl class="login">
                    <VButton color="primary" bold fullwidth raised @click="doReset"> Set Password </VButton>
                  </VControl>
                </VField>
