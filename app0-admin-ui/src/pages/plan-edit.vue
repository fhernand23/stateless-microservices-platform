    ...
    <div class="page-content-inner">
      <VBreadcrumb
        ...
        :items="[
          ...
          {
            label: theObj.name,
            to: { name: 'plan-edit', params: { objId: theObj.id } },
          },
        ]"
        with-icons
      />
        ...
        <div class="columns">
          ...
          <div v-if="theObj" class="column is-4">
            <div class="account-box is-navigation">
              <template v-if="isNew()">
                <VBlock title="New Plan" subtitle="Enter plan details" center>
                  <template #icon>
                    <VAvatar initials="NU" size="large" />
                  </template>
                </VBlock>
              </template>
              <template v-if="!isNew() && theObj.name">
                <VBlock :title="theObj.name" subtitle="Available Plan" center>
                  <template #icon>
                    <Logo :image="theObj.image" :name1="theObj.name" size="large" />
                  </template>
                </VBlock>
              </template>

              <div v-if="!isNew() && theObj.id" class="account-menu">
                <RouterLink :to="{ name: 'plan-edit', params: { objId: theObj.id } }" class="account-menu-item">
